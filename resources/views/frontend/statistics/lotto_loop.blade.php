        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <form class="form-horizontal" method="POST" id="main_form">
                    ...
                    <div class="form-group">
                        <label for="code" class="col-sm-3 control-label">Dàn lotto thống kê</label>
                        <div class="col-sm-3">
                            <input type="text" class="form-control" id="numbers" name="numbers"
                                   placeholder="Dàn (ngăn cách bằng dấu phẩy)"
                                   value="{{ $number }}">
                        </div>
                        <div class="col-sm-2">
                            <label for="first-digit-switch">Cùng về</label>
                            <input type="checkbox" data-toggle="toggle" data-size="mini" data-onstyle="primary"
                                   data-style="ios" id="together" name="together">
                        </div>
                        <div class="col-sm-2">
