                                ...
                                <form method="post" action="{{ route('settings.update', ['page' => 2]) }}">
                                    ...
                                    @component('back.components.boxinputs')
                                        ...
                                        @include('back.partials.input', [
                                                'input' => [
                                                 'title' => __('Số mơ'),
                                                 'name' => 'front_dream_numbers',
                                                 'value' => old('front_dream_numbers', config('app.nbrPages.front.dream_numbers')),
                                                 'input' => 'slider',
                                                 'min' => 20,
                                                 'max' => 100,
                                             ]
                                        ...
                                        @include('back.partials.input', [
                                                'input' => [
                                                 'title' => __('Thông báo'),
                                                 'name' => 'front_notify',
                                                 'value' => old('front_notify', config('app.nbrPages.front.notify')),
                                                 'input' => 'slider',
                                                 'min' => 2,
                                                 'max' => 10,
                                             ]
                                    ...
                                    @component('back.components.boxinputs')
                                        ...
                                        @include('back.partials.input', [
                                           'input' => [
                                               'title' => __('Notify'),
                                               'name' => 'back_notify',
                                               'value' => old('back_notify', config('app.nbrPages.back.notify')),
                                               'input' => 'slider',
                                               'min' => 2,
                                               'max' => 10,
                                           ],
