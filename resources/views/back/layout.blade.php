...
<div class="wrapper">
  ...
  <aside class="main-sidebar">
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        ...
        <li {{ currentRouteBootstrap('admin.index') }}>
          <a href="{{ route('admin.index') }}"><i class="fa fa-fw fa-dashboard"></i> <span>@lang('Dashboard')</span></a>
        </li>
        @admin
        ...
        <li><a href="{{ route('notify.index') }}"><i class="fa fa-list"></i> <span>@lang('Thông báo')</span></a></li>
        @endadmin
        ...
        @admin
          <li><a href="{{ route('settings.edit') }}"><i class="fa fa-cog"></i> <span>@lang('Cấu hình Hệ Thống')</span></a></li>
        @endadmin

        @admin
        <li><a href="{{ route('sites.edit') }}"><i class="fa fa-cog"></i> <span>@lang('Cấu hình ')</span></a></li>
        @endadmin

        @admin
        <li><a href="{{ route('admin.crawler.index') }}"><i class="fa fa-bug"></i> <span>@lang('Crawlers')</span></a></li>
        @endadmin

        @admin
        <li><a href="{{ route('admin.lotteries.report') }}"><i class="fa fa-bug"></i> <span>@lang('Dữ liệu crawler mới nhất')</span></a></li>
        @endadmin

        @admin
        <li><a href="{{ route('admin.advertises.index') }}"><i class="fa fa-file-image-o"></i> <span>@lang('Advertises')</span></a></li>
        @endadmin
  ...
  <footer class="main-footer">
    <!-- Default to the left -->
    <strong>Copyright &copy; {{ date('Y') }} <a href="#">@lang('Vdev Solutions')</a>.</strong> @lang('All rights reserved').
  </footer>
...
<script type="text/javascript" src="https://cdnjs.cloudflare.com/ajax/libs/bootstrap-datepicker/1.8.0/js/bootstrap-datepicker.min.js
"></script>
