...
class DatabaseSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        Post::create([
            ...
            'description' => 'Aperiam molestiae ut sed vel harum nulla vel.',
