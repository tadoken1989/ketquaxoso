    ...
    @if($resultLottery)
        <div class="col-sm-5">
            <div class="kqbackground vien">
                <div id="outer_result_hcm">
                    <div class="panel-heading">
                        <h3 class="right-menu-title"><i class="fa fa-bar-chart"></i>Vietlott Power 6/55</h3>
                    </div>
                    <div class="result_div" id="result_hcm">
                        ...
                        <h2 class="red text-center">Kết quả xổ số Vietlott Power 6/55</h2>
                        ...
                        <table class="table table-condensed kqcenter kqvertimarginw table-kq-border table-kq-hover table-kq-north-west table-bordered kqbackground table-kq-bold-border"
                            ...
                            @php($prizeNames = ['Jackpot 1', 'Jackpot 2', 'Giải nhất','Giải nhì','Giải ba'])
            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h3 class="right-menu-title"><i class="fa fa-bar-chart"></i> Thống kê nhanh Vietlott Power 6/45</h3>
                </div>
